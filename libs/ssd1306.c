...
void desenhar_prioridade(ssd1306_t *ssd)
{
  ssd1306_fill(ssd, false);

  if (get_prioridade()==DISPLAY_DESATIVADO) 
  {
  ...
  ssd1306_draw_string(ssd, "Nivel de Urg.:", 5, 25);

  sprintf(str, "%d", get_prioridade()); // Converte em string

  ssd1306_draw_string(ssd, str, 56, 35);
